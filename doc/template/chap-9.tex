...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=1]{Images/functie4.pdf} 
\caption{The benefit function of the defender for a cost $k_{D} =1$, $d =2$ and $\delta_{D}=1.5$. The three pieces match with the three colours.}
\label{pfb}
\end{figure}
