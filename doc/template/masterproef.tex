...
%bereikt, mogelijk geweest zijn
 Many people have helped in the realization of this thesis. 
  ...
  First I would like to thank my promoter and my assistants for their excellent support during the writing of this paper. They helped me figure out what to do and put a lot of time and effort in me.\\
   ...
   I would also like to thank my boyfriend who supported me during the writing of this thesis and helped me not to flip out.  \\
   
   Last but not least all the people that read my thesis for faults: My mother, my brother Hans, Matthias van der Hallen, Robin Ska and Stijn De Haes.\\
   
   A few other people earn a special mention: Revue-blokt for keeping me focused on my thesis, DistriNet labo for letting me in and study in a quit place and Antonio for distracting me and telling me stories about his travels.
...
We berekenden de benefit voor beide spelers voor de volgende drie gevallen: Wanneer $ \delta_ {D} $ kleiner is dan $ d $. Wanneer $ \delta_ {D} $ kleiner is dan $ \delta_ {A} $ en wanneer het groter is dan $ \delta_ {A} $. \\
De benefit formules voor case 1 en case 2.b leiden tot hetzelfde resultaat. Deze twee cases kunnen worden samengebracht door het aanpassen van de randvoorwaarden. Figuur \ref{grensen} toont de cases en hoe ze samengebracht kunnen worden. Case 1 en case 2.b liggen naast elkaar. Het resultaat van het samenbrengen is visueel te zien in figuur \ref{samenb}.\\

\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.5]{Images/borders.pdf}
\caption{De voorstelling van alle cases waarvoor de benefit berekend is.}
\label{grensen}
\end{figure}

\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.5]{Images/defborders.pdf}
\caption{De voorstelling van de nieuwe randvoorwaarden door het samenbrengen van case 1 en case 2.b.}
\label{samenb}
\end{figure}

De benefit functies als piecewise functies voor elke case:\\
De benefit formule voor de verdediger:
\begin{displaymath}
...
\end{displaymath}
~~ \\
De benefit formule voor de aanvaller:
\begin{displaymath}
...
Na het bepalen van de benefit functies zijn we ge"interesseerd in de optimale strategi"en van de aanvaller en de verdediger. Vanuit deze strategi"en kunnen later de Nash evenwichten bepaald worden.\\
