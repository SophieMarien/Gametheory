...
Een Flipit spel bestaat uit een enkele bron. Om het security probleem voor te stellen van een APT die propageert in een netwerk, defini"eren we het spel als een computer netwerk met meerdere bronnen in plaats van een enkele bron zoals in het basische FlipIt spel. Een van de spelers, de verdediger, zal proberen om zijn netwerk te verdedigen. Hij zal dit doen door elke bron van het netwerk te flippen. De andere speler, de aanvaller, zal proberen om alle bronnen in het netwerk te infecteren. De aanvaller zal dit doen door een APT te droppen op een van de bronnen in het netwerk. Deze APT zal zich dan verspreiden en andere bronnen in het netwerk infecteren. \\

Na het droppen van een APT op een bron in het netwerk, duurt het een tijdje voor het virus het gehele netwerk heeft geinfecteerd. Dus de veronderstelling dat de aanvaller volledige controle heeft over et gehele netwerk van zodra een knooppunt besmet is, is niet realistisch. De aanvaller heeft slechts controle over heel het netwerk van zodra er een voldoende aantal bronnen besmet zijn.
De tijd die nodig is voor het virus om elke bron te infecteren (of een voldoende aantal bronnen) wordt
aangeduid als een infectie-vertraging variabele \textit{d} (de zogenaamde "vertraging" die we als term in de rest van de thesis gaan gebruiken). Om de waarde van \textit{d} te berekenen om alle bronnen in het netwerk te besmetten, is het voldoende om het kortste pad te berekenen tussen de eerst ge"infecteerde bron en de bron die het verst hiervan af staat. De variabele $ d $ kan ook dienen om de tijd aan te duiden die nodig is om een voldoende aantal bronnen te infecteren.
%--------------------------------------- hier ben ik geraakt --- bronnen knooppunten netwerk nakijken ----
Veronderstel dat een aanvaller aanvalt op moment \ textit {t}. Hij krijgt niet onmiddellijk de controle over het netwerk, maar pas na \ textit {t + d} tijd met $ d $ de tijd die nodig is om een voldoende aantal knooppunten te infecteren (of alle). Als de klep te verdedigen het netwerk voordat de periode $ d $ verstreken is (dus ergens tussen de $ t $ en $ t + d $), Dan is de aanvaller zal nooit volledige controle over de bron te krijgen. Dit impliceert dat de wiskundige formules voor de winst en voordeel moeten worden aangepast aan het feit dat de aanvaller verliest een deel van zijn voordeel esta Vanwege vertraging. In de rest van esta papier, zullen we de formalisering van de Flipit spel aan te passen met behulp van de variabele $ d $. \\
