...
%adapted optimum functions for the defender and the attacker. These adapted optimum functions yield a number of interesting cases.
...
%introduces a PageRank matrix to calculate the importance of every node in the network.
