...
<<<<<<< Updated upstream
Once a node is infected it will stay infected. Every node has the same
chance to be infected. The simple epidemic model is considered to be of a fixed size. The model for a fixed population is as follows:
=======
