...
The PageRank of each page on the internet is the dominant eigenvalue of the Google Matrix. The Google Matrix is a stochastic matrix and represents a graph where every edge denotes a link between pages. Through the power iteration \citep{Arnoldi}, the PageRank of all the pages can be calculated iteratively. \\
