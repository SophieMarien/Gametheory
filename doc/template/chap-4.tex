...
To calculate the delay of a worm propagation we assumed that every node is even important. A possible relaxation of this rule can be done by the Page Rank Algorithm, which can be used to determine the importance of certain nodes. 
