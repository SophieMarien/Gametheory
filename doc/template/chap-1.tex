...
In the following paragraph an introduction to game theory is given based on the work of \todo{werk van Essentials of Game Theory} and \todo{Coursera game theory}. Voor een meer gedetailleerdere intro ook dit book.
%------------------------------------------------%
%            Intro Game Theory 					 %
%------------------------------------------------%
