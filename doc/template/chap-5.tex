...
Games can be divided into two types of games: cooperative or non-cooperative. In \textit{non cooperative games}, the basic modelling unit is the group of agents. 
Two or more agents want to maximise their utility and their actions can be affected by other agents' utilities. In the individualistic approach the basic modelling is only one agent. This type of game is referred to as \textit{cooperative games}. 
