\chapter{Intoduction to the general context of the work}
...
\end{enumerate}
 ...
 \\
Information security is divided into two main areas of security. One of them is cyber security also known as computer security. This is the process of applying security tools to ensure confidentiality, integrity, and availability of data. the other area is Network or Internet security.. The difference between these two terms has been lost over time. \todo{what is cyber security? In deze tekst lijkt het op computer security} 
