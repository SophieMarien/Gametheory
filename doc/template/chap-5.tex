...
Figure 1 shows the various combinations of the possible actions of the two players. The Nash equilibrium of the game is that they both remain silent, but perfectly rational players still choose to confess both. This is because this is the dominant strategy. A dominant strategy is a strategy that is better than all other strategies of a player regardless of the opponent. Here it is advantageous for each player to confess. This gives them three years in prison instead of a year. Why players choose one or the other action can be explained by means of game theory.

\begin{figure}[hbtp]
\caption{The prison dilemma: P1 corresponds to the first column, P2 corresponds to the second column.}
\centering
\includegraphics[scale=1]{Images/PrisDilemma.jpg}
\end{figure}
